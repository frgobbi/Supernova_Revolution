...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
       <?php
        ...
        include "../connessione.php";
        try {
                $sql = "SELECT `nome`, `cognome`, `email`, `username`, `cod` FROM `staff` WHERE `username` = '$us' AND `password`='$pw'";
        ...
        if ($_SESSION['login']!=TRUE)
        {
            ...
            echo("<input type=\"password\" class=\"form-control\" id=\"pass\" name=\"pass\" />");
            echo("<label id=\"err\">* Username o Password errati</label>");
            echo("</div>");
